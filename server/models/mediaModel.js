...
//	Title:{ type: String },
//	Locator:{ type: String },
//	Status:{ type:Number },		//1-when tag information will be assigned, 0- when admin media uploader submits. 2- When User adds Media without tags. it means media added from the front-end will never have Status 0, Either 2 or 1.
...
//	thumbnail:{type:String} //added by manishp on 19122014 object - {"100X100":"",}

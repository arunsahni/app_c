...
//		$(".switch-btn").addClass("switch-btn-on");
	...
	// ---- TRANSITION EFFET ---- //
	$(".transition-effect-show").click(function(){
            $(".transition-effect-box").show();
	});
...
// ---- CLOSE POPUP WINDOW CLICK OUTSIDE ---- //
 $(document).ready(function () {
     $('.widget-tollbar-popup, .text-widget-popup, .transition-effect-box').hide()
 });

 $(document).mouseup(function (e) {
     var popup = $(".widget-tollbar-popup, .text-widget-popup, .transition-effect-box");

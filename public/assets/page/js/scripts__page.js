        ...
        var app = {
			...
			*/
			initSearchAnim: function(){
				...
				/*//on 14042016 - removed on click to small header area - slideDown big header case.
			...
			*/
			initAnsboxAnim: function(){
				...
				$('.ansr-box-inr').on('keypress',function(){
					...
					}else if ( text.indexOf("Start typing...") != -1 ) {

						$('.ansr-box-inr').editable('setHTML','');
				...
				$('.ansr-box-inr').on('focus',function(){
					...
					if ($('.ansr-box-inr').text().indexOf('Start typing and click on the keywords OR drop any media from the web or your drive.') != -1) {
						...
						$('.ansr-box-inr').editable('setHTML','Start typing...');
				...
				$('.ansr-box-inr').on('blur',function(){
					...
					//var text = $('.ansr-box-inr').editable('getText');

					if ($('.ansr-box-inr').text() == '') {


						$('.ansr-box-inr').editable('setHTML','Start typing and click on the keywords OR drop any media from the web or your drive.');

					}else if (text.trim().indexOf("Start typing...")  != -1 || text == "Unlicensed Froala Editor") { /*|| text.toLowerCase().indexOf("froala") > 0*/

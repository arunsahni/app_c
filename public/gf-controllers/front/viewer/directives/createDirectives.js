...
collabmedia.compileProvider.directive('setTrustedBg' , [function(){
    return {
        ...
        link : function(scope , element , attr){
            ...
            //if(element.attr('src').find('youtube')){
                //if(element.attr('src').find('?')){
...
collabmedia.compileProvider.directive('showroomTextWidget', ["$sce" , function($sce){
    return {
        ...
        link: function(scope, element, attrs) {
            console.log("--------Showroom--------------textWidget--------scope.obj" , scope.obj);
            console.log("--------Showroom--------------textWidget--------scope.cpbuilder" , scope.cpbuilder);
        }
    }
}]);

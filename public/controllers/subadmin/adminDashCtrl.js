...
collabmedia.controller('adminDashCtrl',function($scope,$http,$location,loginService,$window,$rootScope){
	$rootScope.loggedIn=true;
	
	/*
	loginService.chkAdminLogin($http,$location,$window).then(function(data){
		$scope.adminInfo = tempData;
		//$location.path('/dashboard');
	});
	*/
	$scope.adminLogout = function() {	
		$http.get('/subadmin/logout').then(function (data, status, headers, config) {

...
collabmedia.config(function($httpProvider,$stateProvider, $locationProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $urlRouterProvider) {
  ...
  var checkLoggedin = function($q,  $timeout, $http, $location,$rootScope,$window)
	{
		...
		{ 
			...
			$rootScope.UserDetails = data.usersession ? data.usersession : {};
  ...
  $stateProvider	
			...
			"":{
				...
				resolve: {deps: function($q, $rootScope){
					var dependencies =  [
                                                                ...
                                                                //contentpagebuilder dependencies
                                                                '/controllers/front/creation/services/cpPageService.js',
                                                                '/controllers/front/creation/contentPageBuilder.js',
	...
	.state('dasheditChapters', {
		url: "/dashedit-chapters/:id",
		views:{
			"":{
				templateUrl: "../views/front/creation/edit/manage-chapters.html",
				//template: "<h1 style='color:black; align:center'>Create Chapter<br>OPPS!!! We are working on it.. to go to a board <a href='#/discuss/55a3a6ecdf65c2555862dc10'>click here</a></h1>",
				controller:"ChaptersMgmtCtrl",
				resolve: {deps: function($q, $rootScope){
					var dependencies =  [
                                            '/controllers/front/creation/dashboard/edit/directives/createDirectives.js',
                                            '/controllers/front/creation/dashboard/edit/services/chaptersService.js',
                                            '/controllers/front/creation/dashboard/edit/chaptersMgmtCtrl.js',
                                            '/controllers/front/creation/dashboard/edit/services/pagesService.js',
                                            '/controllers/front/creation/dashboard/edit/services/lsService.js',
                                            '/services/front/loginService.js',
                                        ];
					return loadDependencies($q, $rootScope, dependencies);
				},check:checkLoggedin}
	...
	.state('dashEditPages', {
		url: "/dashedit-pages/:capsule_id/:id",
		views:{
			"":{
				templateUrl: "../views/front/creation/edit/manage-pages.html",
				//template: "<h1 style='color:black ; align:center'>Create Page<br>OPPS!!! We are working on it.. to go to a board <a href='#/discuss/55a3a6ecdf65c2555862dc10'>click here</a></h1>",
				controller:"PagesMgmtCtrl",
				resolve: {deps: function($q, $rootScope){
					var dependencies =  [
					    '/controllers/front/creation/dashboard/edit/services/dashPagesService.js',
                                            '/controllers/front/creation/dashboard/edit/directives/createDirectives.js',
                                            '/controllers/front/creation/dashboard/edit/services/sgPageService.js',
                                            '/controllers/front/creation/dashboard/edit/pagesMgmtCtrl.js',
                                            '/services/front/loginService.js',
                                            '/controllers/front/creation/dashboard/edit/services/lsService.js',
                                        ];
					return loadDependencies($q, $rootScope, dependencies);
	...
	.state('manageLS', {				//testing not in use
		url: "/ls/:capsule_id/:jump_to",
		views:{
			"":{
				templateUrl: "../views/front/creation/ls.html",
				controller:"lsMgmtCtrl",
	...
	.state('manageLS5', {				//testing not in use
		url: "/launch/:capsule_id/:jump_to",
		views:{
			"":{
				templateUrl: "../views/front/creation/ls-own.html",
				controller:"lsOwnMgmtCtrl",
	...
	.state('manageCP2', {
		...
		views:{
			...
			"":{
				...
				//template: "<h1 style='color:black ; align:center'>Content Page Builder</h1>",
				controller:"ContentPageBuilder",
				resolve: {deps: function($q, $rootScope){
					var dependencies =  [
                                                                '/assets/page/js/oEmbeder.js',
                                                                '/controllers/front/pages/uploadLinkEngine.js',
                                                                '/controllers/front/pages/uploadMediaCtrl.js',
                                                                '/controllers/front/creation/services/cpPageService.js',
                                                                '/controllers/front/creation/contentPageBuilder.js',
    ...
    .state('viewer', {
        url: "/viewer/:chapter_id",
        views:{
                //params : {capsule_id:null,chapter_id:null,page_id:null},
                "":{
                    //params : {capsule_id:null,chapter_id:null,page_id:null},
                    templateUrl: "../views/front/viewer/chapter-view.html",
                    controller:"ContentPageBuilder",
                    resolve: {deps: function($q, $rootScope){
                        var dependencies =  [
                            '/assets/page/js/oEmbeder.js',
                            '/controllers/front/pages/uploadLinkEngine.js',
                            '/controllers/front/pages/uploadMediaCtrl.js',
                            '/controllers/front/viewer/services/cpPageService.js',
                            '/controllers/front/viewer/contentPageBuilder.js',
                            '/controllers/front/viewer/directives/createDirectives.js',
                            '/services/front/loginService.js'
                            //'/controllers/front/creation/cpPageMgmtCtrl.js'
                            //'../vendors/cPageBuilder/ng-content-page-builder.js',
                        ];
    ...
    .state('viewer2', {
        url: "/viewer/:capsule_id/:chapter_id/:page_id",
        views:{
                //params : {capsule_id:null,chapter_id:null,page_id:null},
                "":{
                    //params : {capsule_id:null,chapter_id:null,page_id:null},
	 ...
	 .state('userGalleryPreview', {
		url: "/userGallery-preview/:chapter_id/:page_id",
		views:{
			"":{
				templateUrl: "../views/front/preview/userGalleryIndex.html",
				//templateUrl: "../views/front/preview/preview.html",
				controller:"PreviewIndexCtrl",
				resolve: {deps: function($q, $rootScope){
					var dependencies =  [

...
//request service
collabmedia.provide.service('DashPagesService', ['$http' , '$q' , function( $http , $q ){
	//get requests list
	return {
		...
		getDashAll : function(chapter_id){
			//console.log('###########################################',chapter_id);
			$http.defaults.headers.common['chapter_id'] = chapter_id;
			
			return $http.get('/pages/findAlldashedit?chapter_id='+chapter_id)
				.success(function(response){
					delete $http.defaults.headers.common['chapter_id'];
		...
		create : function(chapter_id , pageType){
			...
			return $http.post('/pages/dashEditCreate' , {chapter_id : chapter_id , page_type : pageType})
				.success(function(response){
					delete $http.defaults.headers.common['chapter_id'];
		...
		addFromLibrary : function(chapter_id , id){
			...
			return $http.post('/pages/addFromLibrary_dashEdit')
				.success(function(response){
					delete $http.defaults.headers.common['chapter_id'];
					delete $http.defaults.headers.common['page_id'];
		...
		publishNewChanges : function(chapter_id){
			$http.defaults.headers.common['chapter_id'] = chapter_id;
			return $http.post('/pages/publishNewUpdates_dashedit')
				.success(function(response){
					delete $http.defaults.headers.common['chapter_id'];
		...
		revertNewChanges : function(chapter_id){
			$http.defaults.headers.common['chapter_id'] = chapter_id;
			return $http.post('/pages/revertDashEditCopy')
				.success(function(response){
					delete $http.defaults.headers.common['chapter_id'];
					if(response){
						return { response:$q.defer().resolve(response) };

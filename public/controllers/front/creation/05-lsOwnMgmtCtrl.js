...
collabmedia.controllerProvider.register('lsOwnMgmtCtrl',['$scope', '$location','$timeout','loginService','LSService','$stateParams','ChaptersService','LaunchSettingsService','CapsulesService', function($scope, $location, $timeout, loginService,LSService,$stateParams,ChaptersService,LaunchSettingsService,CapsulesService){

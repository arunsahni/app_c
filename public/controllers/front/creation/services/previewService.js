...
collabmedia.provide.service('PreviewService', ['$http' , '$q' , function( $http , $q ){
	...
	return {
		...
		userGalleryMedia : function(inputObj){
			return $http.post('/pages/userGalleryMedia',inputObj)
				.success(function(response){
					if(response){
						return { response:$q.defer().resolve(response) };
					}
		...
		deleteGalleryMedia : function(inputObj){
			return $http.post('/pages/deleteGalleryMedia',inputObj)
				.success(function(response){
					if(response){
						return { response:$q.defer().resolve(response) };
					}

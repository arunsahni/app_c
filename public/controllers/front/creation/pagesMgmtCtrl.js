...
collabmedia.controllerProvider.register('PagesMgmtCtrl',['$scope','$stateParams','$location','$timeout','$state','$window','loginService','PagesService','SgPageService','LSService', function($scope,$stateParams,$location,$timeout,$state,$window,loginService,PagesService,SgPageService,LSService){
                            ...
                            LSService.getChapters(this.capsule_id).then(function(data){
                                if (data.data.code==400) {
                                    ...
                                    if (data.data.chapter_ids.length == 0) {
                                        ...
                                        $location.path('/ls/'+$scope.PagesMgmt.capsule_id +'/' +section);
                                    }
                                }
                            });
